...
import com.ezapi.api.domain.Product;
import com.ezapi.api.repository.ProductRepository;
import com.ezapi.api.service.dto.ProductDTO;
import com.ezapi.api.service.mapper.ProductMapper;
...
class ProductResourceIT {
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product().productid(DEFAULT_PRODUCTID);
        return product;
    }
    ...
    public static Product createUpdatedEntity(EntityManager em) {
        Product product = new Product().productid(UPDATED_PRODUCTID);
        return product;
    }
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getProductid()).isEqualTo(DEFAULT_PRODUCTID);
    }
    ...
    void putNewProduct() throws Exception {
        ...
        updatedProduct.productid(UPDATED_PRODUCTID);
        ...
        Product testProduct = productList.get(productList.size() - 1);
        assertThat(testProduct.getProductid()).isEqualTo(UPDATED_PRODUCTID);
    }
    ...
    void fullUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.productid(UPDATED_PRODUCTID);
