...
import com.ezapi.api.service.ProductService;
...
/**
 * REST controller for managing {@link com.ezapi.api.domain.Product}.
 */
@RestController
@RequestMapping("/api")
public class ProductResource {
    ...
    private static final String ENTITY_NAME = "advworksProduct";
